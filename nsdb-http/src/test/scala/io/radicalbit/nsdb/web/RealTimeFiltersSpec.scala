...
import io.radicalbit.nsdb.actors.RealTimeProtocol.Events.SubscribedByQueryString
...
//  val wsSecureResources = wsResources(publisherActor, new TestAuthProvider)
  ...
  "Real Time Filter" should {
    ...
    "register a query and receive events with a single filter over Long with String filter provided" in {

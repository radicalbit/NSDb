...
public class TaxonomyFacetSumLongAssociations extends LongTaxonomyFacets {

    /** Create {@code TaxonomyFacetSumLongAssociations} against
     *  the default index field. */
    public TaxonomyFacetSumLongAssociations(TaxonomyReader taxoReader, FacetsConfig config, FacetsCollector fc) throws IOException {
        this(FacetsConfig.DEFAULT_INDEX_FIELD_NAME, taxoReader, config, fc);
    }

    /** Create {@code TaxonomyFacetSumLongAssociations} against
     *  the specified index field. */
    public TaxonomyFacetSumLongAssociations(String indexFieldName, TaxonomyReader taxoReader, FacetsConfig config, FacetsCollector fc) throws IOException {

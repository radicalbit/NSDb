...
class NamespaceActorSpec()
  ...
  "namespaceActor" should "write and delete properly" in {
    ...
    val record = Record(System.currentTimeMillis, Map("content" -> s"content"), 0.5)
  ...
  "namespaceActorSpec" should "write and delete properly in multiple namespaces" in {
    ...
    val record = Record(System.currentTimeMillis, Map("content" -> s"content"), 24)
  ...
  "namespaceActorSpec" should "delete a namespace" in {
    ...
    val record = Record(System.currentTimeMillis, Map("content" -> s"content"), 23)

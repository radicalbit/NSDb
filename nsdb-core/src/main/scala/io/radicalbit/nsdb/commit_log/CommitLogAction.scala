...
object CommitLogAction {

  @JsonTypeInfo(use = JsonTypeInfo.Id.NAME, property = "type")
  @JsonSubTypes(
    Array(
      new JsonSubTypes.Type(value = classOf[InsertBitAction], name = "InsertBitAction"),
  ...
  case class InsertBitAction(bit: Bit)                            extends CommitLogAction
